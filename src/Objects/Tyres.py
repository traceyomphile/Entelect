...
class TyreProperties:
    def __init__(
        ...
        dry_friction_mult,
        cold_friction_mult,
        light_rain_friction_mult,
        heavy_rain_friction_mult,
        dry_degradation_mult,
        cold_degradation_mult,
        light_rain_degradation_mult,
        heavy_rain_degradation_mult,
    ):
...
class Tyres:
    ...
    def __init__(self, properties, available_sets):
